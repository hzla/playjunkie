...
(function() {
  ...
  QuizNew = {
    ...
    addQuestion: function() {
      ...
      newQuestion.find('.form-answer.text-style').hide();
...
(function() {
  ...
  QuizSort = {
    init: function() {
      $('body').on('click', '.sort-bar p:not(.label)', this.chooseSortOption);
      return $("p.selected").click();
    },
...
(function() {
  ...
  SocialMedia = {
    ...
    shareTw: function() {
      return window.open("https://twitter.com/intent/tweet?", 'Tweet!', 'height=600px,width=800px');
    },
