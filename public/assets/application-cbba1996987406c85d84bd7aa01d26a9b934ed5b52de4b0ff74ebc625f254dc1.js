...
(function() {
  ...
  FlipcardNew = {
    init: function() {
      ...
      return $('body').on('keyup', '.text-box', this.syncItemText);
    },
    chooseSide: function() {
      var card;
  ...
  QuizSort = {
    ...
    sortByOption: function(sortName) {
      if (sortName === "pd") {
        ...
        return QuizSort.sortByPopularity;
      } else {
        return QuizSort.sortByName;
      }
    },
    sortByPopularity: function(a, b) {
      return $(b).attr('view_count').localeCompare($(a).attr('view_count'));
    },
