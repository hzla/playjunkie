...
(function() {
  ...
  QuizImageUpload = {
    ...
    showImagePreview: function() {
      var formData, input, reader, uploadForm;
      input = this;
      ...
      if (input.files && input.files[0]) {
        ...
        $(this).parent().parent().find('.close-image').show();
...
(function() {
  ...
  QuizNew = {
    ...
    addQuestion: function() {
      ...
      quizId = $('.edit_quiz').attr('quiz_id');
      quizType = $('#quiz_type').val();
      $.post("/quizzes/" + quizId + "/quiz_items?i=" + ($('.question').length) + "&quiz_type=" + quizType, function(data) {
        return $('.question:visible').last().after(data);
      });
      QuizNew.questionCount += 1;
