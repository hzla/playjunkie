...
(function() {
  ...
  QuizImageUpload = {
    init: function() {
      ...
      return $('body').on('click', '.close-image', this.closeImage);
    },
...
(function() {
  ...
  QuizNew = {
    ...
    addAnswer: function() {
      ...
      $.post("/quiz_items/" + quizItemId + "/answers?item_number=" + itemNumber + ")}&i=" + i + "&quiz_type=" + quizType, function(data) {
        return lastAnswer.after(data);
      });
