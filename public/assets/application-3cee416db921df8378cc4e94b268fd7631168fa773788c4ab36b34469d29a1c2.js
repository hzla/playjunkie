...
(function() {
  ...
  QuizNew = {
    init: function() {
      ...
      $('body').on('click', '#submit-bar .btn', this.submitQuiz);
    ...
    validateFields: function() {
      var correctAnswersCount, i, image, incorrectNumberofAnswers, j, missingFieldError, question, quizDescription, quizImage, quizTitle, ref, text;
    ...
    moveQuestion: function() {
      ...
      return QuizNew.displayMovers();
    },
    displayMovers: function() {
      $('.move-question').show();
    ...
    closeAnswer: function() {
      ...
      return $('.form-answers:visible').find('.add-answer').show();
    },
    displayClosers: function() {
    ...
    showImagePreview: function() {
      ...
      if (input.files && input.files[0]) {
        ...
        return $(this).parents('.box-field').find('.close-image').show();
      }
    },
    closeImage: function() {
      var box;
      box = $(this).parents('.box-field');
