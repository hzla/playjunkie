...
(function() {
  ...
  QuizValidate = {
    ...
    validateFields: function() {
      var correctAnswersCount, description, flipCardError, i, image, imageBack, imageFront, incorrectNumberofAnswers, j, listItemError, missingFieldError, question, quizDescription, quizImage, quizTitle, ref, text, textBack, textFront;
      ...
      for (i = j = 0, ref = $('.question').length - 1; 0 <= ref ? j <= ref : j >= ref; i = 0 <= ref ? ++j : --j) {
        question = $($('.question')[i]);
